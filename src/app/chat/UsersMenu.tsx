...
const UsersMenu: FC<UsersMenuProps> = ({
  ...
  return (
    <div className="str-chat absolute z-10 h-full w-full overflow-y-auto border-e border-e-[#DBDDE1] bg-white dark:border-e-gray-800 dark:bg-[#17171c]">
  ...
  return (
    ...
    >
      <input
        ...
        checked={selected}
        onChange={(e) => {
          onChangeSelected(e.target.checked);
        }}
        onClick={(e) => {
          e.stopPropagation();
        }}
